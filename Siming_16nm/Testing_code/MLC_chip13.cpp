...
int main(void) {
	...
	sprintf(Measure_file, "C:/GoogleDrive/working/MLC_programming_Chip%02d_Col%02d_200msPULSE_VG1p8_VD1p8_VAsource_VBdrain_01", chip, col);
	MLC_programming(Measure_file, VDS_col21, VGS_col21, "200ms", chip, col, 0, 1000, 100, 0.00008);

        sprintf(Measure_file, "C:/GoogleDrive/working/MLC_Chip%02d_Col%02d_200msPULSE_VG1p8_VD1p8_Ids_Vgs_VAsource_VBdrain_01", chip, col);   
	IDS_VGS(Measure_file, col, chip, 0);                                       
        sprintf(Measure_file, "C:/GoogleDrive/working/MLC_Chip%02d_Col%02d_200msPULSE_VG1p8_VD1p8_Ids_Vgs_VAdrain_VBsource_01", chip, col);   
	IDS_VGS(Measure_file, col, chip, 1);
	...
	sprintf(Measure_file, "C:/GoogleDrive/working/MLC_programming_Chip%02d_Col%02d_200msPULSE_VG1p8_VD2p0_VAsource_VBdrain_02", chip, col);
	MLC_programming(Measure_file, VDS_col21, VGS_col21, "200ms", chip, col, 0, 1000, 100, 0.00006);

        sprintf(Measure_file, "C:/GoogleDrive/working/MLC_Chip%02d_Col%02d_200msPULSE_VG1p8_VD2p0_Ids_Vgs_VAsource_VBdrain_02", chip, col);   
	IDS_VGS(Measure_file, col, chip, 0);                                        
        sprintf(Measure_file, "C:/GoogleDrive/working/MLC_Chip%02d_Col%02d_200msPULSE_VG1p8_VD2p0_Ids_Vgs_VAdrain_VBsource_02", chip, col);   
	IDS_VGS(Measure_file, col, chip, 1);
	...
	sprintf(Measure_file, "C:/GoogleDrive/working/MLC_programming_Chip%02d_Col%02d_200msPULSE_VG1p8_VD2p2_VAsource_VBdrain_03", chip, col);
	MLC_programming(Measure_file, VDS_col21, VGS_col21, "200ms", chip, col, 0, 1000, 100, 0.00004);

        sprintf(Measure_file, "C:/GoogleDrive/working/MLC_Chip%02d_Col%02d_200msPULSE_VG1p8_VD2p2_Ids_Vgs_VAsource_VBdrain_03", chip, col);   
	IDS_VGS(Measure_file, col, chip, 0);                                       
        sprintf(Measure_file, "C:/GoogleDrive/working/MLC_Chip%02d_Col%02d_200msPULSE_VG1p8_VD2p2_Ids_Vgs_VAdrain_VBsource_03", chip, col);   
	IDS_VGS(Measure_file, col, chip, 1);
