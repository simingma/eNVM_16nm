...
int pre_baking_characterization(char *level, int chip, int col){ //level = {'Fresh', 'MLC-1', 'MLC-2', ..., 'MLC-7'}
	...
	sprintf(Measure_file, "E:/Data/%s_pre-baking_Chip%02d_Col%02d_Ids_Vgs_VAsource_VBdrain", level, chip, col);
	IDS_VGS(Measure_file, col, chip, 0);
	sprintf(Measure_file, "E:/Data/%s_pre-baking_Chip%02d_Col%02d_Ids_Vgs_VAdrain_VBsource", level, chip, col);
	IDS_VGS(Measure_file, col, chip, 1); 
        //VD=0.5, VS=VB=0, sweep VG=0.2:0.05:0.8
	sprintf(Measure_file, "E:/Data/%s_pre-baking_Chip%02d_Col%02d_Ids_VD0p5_VS0p0_VB0p0_VG0p2-0p8_VAsource_VBdrain", level, chip, col);
	IDS_sweepVG(Measure_file, col, chip, 0, 0.5, 0.0, 0.0, 0.2, 0.8);
	sprintf(Measure_file, "E:/Data/%s_pre-baking_Chip%02d_Col%02d_Ids_VD0p5_VS0p0_VB0p0_VG0p2-0p8_VAdrain_VBsource", level, chip, col);
	IDS_sweepVG(Measure_file, col, chip, 1, 0.5, 0.0, 0.0, 0.2, 0.8); 
        //VG=0.5, VS=VB=0, sweep VD=0.0:0.05:0.8
	sprintf(Measure_file, "E:/Data/%s_pre-baking_Chip%02d_Col%02d_Ids_VG0p5_VS0p0_VB0p0_VD0p0-0p8_VAsource_VBdrain", level, chip, col);
	IDS_sweepVD(Measure_file, col, chip, 0, 0.5, 0.0, 0.0, 0.0, 0.8);
	sprintf(Measure_file, "E:/Data/%s_pre-baking_Chip%02d_Col%02d_Ids_VG0p5_VS0p0_VB0p0_VD0p0-0p8_VAdrain_VBsource", level, chip, col);
	IDS_sweepVD(Measure_file, col, chip, 1, 0.5, 0.0, 0.0, 0.0, 0.8); 
        //VD=1.0, VS=0.5, VB=0, sweep VG=0.5:0.05:1.3
	sprintf(Measure_file, "E:/Data/%s_pre-baking_Chip%02d_Col%02d_Ids_VD1p0_VS0p5_VB0p0_VG0p5-1p3_VAsource_VBdrain", level, chip, col);
	IDS_sweepVG(Measure_file, col, chip, 0, 1.0, 0.5, 0.0, 0.5, 1.3);
	sprintf(Measure_file, "E:/Data/%s_pre-baking_Chip%02d_Col%02d_Ids_VD1p0_VS0p5_VB0p0_VG0p5-1p3_VAdrain_VBsource", level, chip, col);
	IDS_sweepVG(Measure_file, col, chip, 1, 1.0, 0.5, 0.0, 0.5, 1.3); 
        //VG=1.0, VS=0.5, VB=0, sweep VD=0.5:0.05:1.3
	sprintf(Measure_file, "E:/Data/%s_pre-baking_Chip%02d_Col%02d_Ids_VG1p0_VS0p5_VB0p0_VD0p5-1p3_VAsource_VBdrain", level, chip, col);
	IDS_sweepVD(Measure_file, col, chip, 0, 1.0, 0.5, 0.0, 0.5, 1.3);
	sprintf(Measure_file, "E:/Data/%s_pre-baking_Chip%02d_Col%02d_Ids_VG1p0_VS0p5_VB0p0_VD0p5-1p3_VAdrain_VBsource", level, chip, col);
	IDS_sweepVD(Measure_file, col, chip, 1, 1.0, 0.5, 0.0, 0.5, 1.3); 
        //VD=1.0, VS=0.5, VB=0.5, sweep VG=0.5:0.05:1.3
	sprintf(Measure_file, "E:/Data/%s_pre-baking_Chip%02d_Col%02d_Ids_VD1p0_VS0p5_VB0p5_VG0p5-1p3_VAsource_VBdrain", level, chip, col);
	IDS_sweepVG(Measure_file, col, chip, 0, 1.0, 0.5, 0.5, 0.5, 1.3);
	sprintf(Measure_file, "E:/Data/%s_pre-baking_Chip%02d_Col%02d_Ids_VD1p0_VS0p5_VB0p5_VG0p5-1p3_VAdrain_VBsource", level, chip, col);
	IDS_sweepVG(Measure_file, col, chip, 1, 1.0, 0.5, 0.5, 0.5, 1.3); 
        //VG=0.8, VS=VB=0, sweep VD=0.0:0.05:0.8
	sprintf(Measure_file, "E:/Data/%s_pre-baking_Chip%02d_Col%02d_Ids_VG0p8_VS0p0_VB0p0_VD0p0-0p8_VAsource_VBdrain", level, chip, col);
	IDS_sweepVD(Measure_file, col, chip, 0, 0.8, 0.0, 0.0, 0.0, 0.8);
	sprintf(Measure_file, "E:/Data/%s_pre-baking_Chip%02d_Col%02d_Ids_VG0p8_VS0p0_VB0p0_VD0p0-0p8_VAdrain_VBsource", level, chip, col);
...
int bake_and_characterization(char *level, int bake_iteration, int chip, int col, short room_temperature, short bake_temperature, DWORD baking_time_ms){ 
	...
	char Measure_file[200];
	//standard IDS-VGS: VD=0.8, VS=VB=0, VG=0.2:0.05:0.8
	sprintf(Measure_file, "E:/Data/%s_125C-bake-%02d_Chip%02d_Col%02d_Ids_Vgs_VAsource_VBdrain", level, bake_iteration, chip, col);
	powerOFF_bake_powerON(Measure_file, room_temperature, bake_temperature, baking_time_ms);
	IDS_VGS(Measure_file, col, chip, 0);                                                                      
	sprintf(Measure_file, "E:/Data/%s_125C-bake-%02d_Chip%02d_Col%02d_Ids_Vgs_VAdrain_VBsource", level, bake_iteration, chip, col);
	IDS_VGS(Measure_file, col, chip, 1); 
...
*/
	sprintf(Measure_file, "E:/Data/%s_125C-bake-%02d_Chip%02d_Col%02d_Ids_Vgs_VAdrain_VBsource", "MLC-01_1msPULSE_VG1p8_VD2p0", 5, chip, col);
	IDS_VGS(Measure_file, col, chip, 1);


	//MLC-02
	sprintf(Measure_file, "E:/Data/MLC_programming_Chip%02d_Col%02d_3msPULSE_VG1p8_VD2p0_VAsource_VBdrain_02", chip, col);
	...
	//MLC-03
	sprintf(Measure_file, "E:/Data/MLC_programming_Chip%02d_Col%02d_9msPULSE_VG1p8_VD2p0_VAsource_VBdrain_03", chip, col);
	...
	//MLC-04
	sprintf(Measure_file, "E:/Data/MLC_programming_Chip%02d_Col%02d_27msPULSE_VG1p8_VD2p0_VAsource_VBdrain_04", chip, col);
	...
	//MLC-05
	sprintf(Measure_file, "E:/Data/MLC_programming_Chip%02d_Col%02d_81msPULSE_VG1p8_VD2p0_VAsource_VBdrain_05", chip, col);
