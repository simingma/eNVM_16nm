...
/*
	...
	sprintf(Measure_file, "C:/GoogleDrive/working/MLC_programming_Chip%02d_Col%02d_40msPULSE_VG1p8_VD2p4_VAsource_VBdrain_01", chip, col);
	MLC_programming(Measure_file, VDS_col21, VGS_col21, "40ms", chip, col, 0, 170, 0, 0.00008);

        sprintf(Measure_file, "C:/GoogleDrive/working/MLC_Chip%02d_Col%02d_40msPULSE_VG1p8_VD2p4_Ids_Vgs_VAsource_VBdrain_01", chip, col);   
	IDS_VGS(Measure_file, col, chip, 0);                                       
        sprintf(Measure_file, "C:/GoogleDrive/working/MLC_Chip%02d_Col%02d_40msPULSE_VG1p8_VD2p4_Ids_Vgs_VAdrain_VBsource_01", chip, col);   
	IDS_VGS(Measure_file, col, chip, 1);
	...
	MLC_programming(Measure_file, VDS_col21, VGS_col21, "40ms", chip, col, 0, 170, 0, 0.00006);
	...
	IDS_VGS(Measure_file, col, chip, 0);                                        
        sprintf(Measure_file, "C:/GoogleDrive/working/MLC_Chip%02d_Col%02d_40msPULSE_VG1p8_VD2p4_Ids_Vgs_VAdrain_VBsource_02", chip, col);   
	IDS_VGS(Measure_file, col, chip, 1);
	...
	MLC_programming(Measure_file, VDS_col21, VGS_col21, "40ms", chip, col, 0, 170, 0, 0.00004);
	...
	sprintf(Measure_file, "C:/GoogleDrive/working/MLC_programming_Chip%02d_Col%02d_40msPULSE_VG1p8_VD2p4_VAsource_VBdrain_04", chip, col);
	MLC_programming(Measure_file, VDS_col21, VGS_col21, "40ms", chip, col, 0, 1400, 0, 0.00002);

	sprintf(Measure_file, "C:/GoogleDrive/working/MLC_Chip%02d_Col%02d_40msPULSE_VG1p8_VD2p4_Ids_Vgs_VAsource_VBdrain_04", chip, col);
	IDS_VGS(Measure_file, col, chip, 0);
	sprintf(Measure_file, "C:/GoogleDrive/working/MLC_Chip%02d_Col%02d_40msPULSE_VG1p8_VD2p4_Ids_Vgs_VAdrain_VBsource_04", chip, col);
	IDS_VGS(Measure_file, col, chip, 1);
*/
	...
	MLC_programming(Measure_file, VDS_col33, VGS_col33, "2ms", chip, col, 0, 280, 0, 0.00009);
	...
	MLC_programming(Measure_file, VDS_col33, VGS_col33, "10ms", chip, col, 0, 280, 0, 0.00007);
	...
	MLC_programming(Measure_file, VDS_col33, VGS_col33, "40ms", chip, col, 0, 280, 0, 0.00005);
	...
	MLC_programming(Measure_file, VDS_col33, VGS_col33, "200ms", chip, col, 0, 280, 0, 0.00003);
